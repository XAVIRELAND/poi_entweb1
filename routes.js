...
module.exports = [
    ...
    { method: 'GET', path: '/showUpdate', config: Pois.showUpdate },
//    { method: 'GET', path: '/updatePois', config: Pois.updatePois},
    ...
    { method: 'GET', path: '/deletePois/:id', config: Pois.deletePois },
